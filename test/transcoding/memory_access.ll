...
; CHECK-LLVM: store volatile i32 addrspace(4)* %{{[0-9]+}}, i32 addrspace(4)** %ptr, align 8
; CHECK-LLVM: load volatile i32 addrspace(4)*, i32 addrspace(4)** %ptr, align 8
; CHECK-LLVM: load i32, i32 addrspace(4)* %{{[0-9]+}}, align 4
; CHECK-LLVM: load volatile i32 addrspace(4)*, i32 addrspace(4)** %ptr, align 8
...
; CHECK-LLVM: store i32 addrspace(4)* %{{[0-9]+}}, i32 addrspace(4)** %ptr
