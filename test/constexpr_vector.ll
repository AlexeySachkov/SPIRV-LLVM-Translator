...
; CHECK-LLVM:   %0 = ptrtoint i32 (i32)* @_Z2f2u2CMvb32_j to i64
; CHECK-LLVM:   %1 = ptrtoint i32 (i32)* @_Z2f1u2CMvb32_j to i64
; CHECK-LLVM:   %2 = ptrtoint i32 (i32)* @_Z2f2u2CMvb32_j to i64
; CHECK-LLVM:   %3 = bitcast i64 %2 to <8 x i8>
; CHECK-LLVM:   %4 = ptrtoint i32 (i32)* @_Z2f1u2CMvb32_j to i64
; CHECK-LLVM:   %5 = bitcast i64 %4 to <8 x i8>
; CHECK-LLVM:   %6 = extractelement <8 x i8> %3, i32 7
; CHECK-LLVM:   %7 = extractelement <8 x i8> %3, i32 6
; CHECK-LLVM:   %8 = extractelement <8 x i8> %3, i32 5
; CHECK-LLVM:   %9 = extractelement <8 x i8> %3, i32 4
; CHECK-LLVM:   %10 = extractelement <8 x i8> %3, i32 3
; CHECK-LLVM:   %11 = extractelement <8 x i8> %3, i32 2
; CHECK-LLVM:   %12 = extractelement <8 x i8> %3, i32 1
; CHECK-LLVM:   %13 = extractelement <8 x i8> %3, i32 0
; CHECK-LLVM:   %14 = extractelement <8 x i8> %5, i32 7
; CHECK-LLVM:   %15 = extractelement <8 x i8> %5, i32 6
; CHECK-LLVM:   %16 = extractelement <8 x i8> %5, i32 5
; CHECK-LLVM:   %17 = extractelement <8 x i8> %5, i32 4
; CHECK-LLVM:   %18 = extractelement <8 x i8> %5, i32 3
; CHECK-LLVM:   %19 = extractelement <8 x i8> %5, i32 2
; CHECK-LLVM:   %20 = extractelement <8 x i8> %5, i32 1
; CHECK-LLVM:   %21 = extractelement <8 x i8> %5, i32 0
; CHECK-LLVM:   23 = insertelement <16 x i8> undef, i8 %21, i32 0
; CHECK-LLVM:   %24 = insertelement <16 x i8> %23, i8 %20, i32 1
; CHECK-LLVM:   %25 = insertelement <16 x i8> %24, i8 %19, i32 2
; CHECK-LLVM:   %26 = insertelement <16 x i8> %25, i8 %18, i32 3
; CHECK-LLVM:   %27 = insertelement <16 x i8> %26, i8 %17, i32 4
; CHECK-LLVM:   %28 = insertelement <16 x i8> %27, i8 %16, i32 5
; CHECK-LLVM:   %29 = insertelement <16 x i8> %28, i8 %15, i32 6
; CHECK-LLVM:   %30 = insertelement <16 x i8> %29, i8 %14, i32 7
; CHECK-LLVM:   %31 = insertelement <16 x i8> %30, i8 %13, i32 8
; CHECK-LLVM:   %32 = insertelement <16 x i8> %31, i8 %12, i32 9
; CHECK-LLVM:   %33 = insertelement <16 x i8> %32, i8 %11, i32 10
; CHECK-LLVM:   %34 = insertelement <16 x i8> %33, i8 %10, i32 11
; CHECK-LLVM:   %35 = insertelement <16 x i8> %34, i8 %9, i32 12
; CHECK-LLVM:   %36 = insertelement <16 x i8> %35, i8 %8, i32 13
; CHECK-LLVM:   %37 = insertelement <16 x i8> %36, i8 %7, i32 14
; CHECK-LLVM:   %38 = insertelement <16 x i8> %37, i8 %6, i32 15
; CHECK-LLVM:   store <16 x i8> %38, <16 x i8>* %Funcs, align 16
; CHECK-LLVM:   %Funcs1 = alloca <2 x i64>, align 16
; CHECK-LLVM:   %39 = insertelement <2 x i64> undef, i64 %1, i32 0
; CHECK-LLVM:   %40 = insertelement <2 x i64> %39, i64 %0, i32 1
; CHECK-LLVM:   store <2 x i64> %40, <2 x i64>* %Funcs1, align 16
